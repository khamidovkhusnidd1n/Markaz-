...
# Fix 2: Departments.tsx - dangerouslySetInnerHTML for task_text + restore accordion

with open("frontend/pages/Departments.tsx", "r", encoding="utf-8") as f:
    content = f.read()

# Fix task_text in department_tasks cards (two occurrences - inside task obj and plain tasks)
...
# Restore accordion after detailText block
